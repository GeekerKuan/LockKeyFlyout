...
internal static unsafe class Program
{
    ...
    const int WS_EX_TOPMOST=8, WS_EX_TOOLWINDOW=0x80, WS_EX_NOACTIVATE=0x08000000, WS_EX_LAYERED=0x80000;
    const int LWA_ALPHA=2, TPM_RIGHTBUTTON=2, TPM_BOTTOMALIGN=0x20, MF_STRING=0, MF_SEPARATOR=0x800;
    ...
    const int ID_SETTINGS=1001, ID_EXIT=1002, ID_ENABLE=1003, TRAY_MSG=WM_APP+1, TIMER_HIDE=1, TIMER_ANIM=2;
    ...
    [STAThread] static int Main()
    {
        ...
        flyout=Native.CreateWindowEx(WS_EX_TOPMOST|WS_EX_TOOLWINDOW|WS_EX_NOACTIVATE|WS_EX_LAYERED,"LockKeyFlyout.Popup","",WS_POPUP,0,0,160,50,0,0,instance,0);
